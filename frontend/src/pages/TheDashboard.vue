<template>
  ...
  // disableOnInteraction: false,
        ...
        <swiper-slide><img :src="slide1URL" alt="幻灯片 1" class="slide-1 swiper-lazy" rel="preload" /></swiper-slide>
        <swiper-slide><img :src="slide2URL" alt="幻灯片 2" class="slide-2 swiper-lazy" rel="preload" /></swiper-slide>
        <swiper-slide><img :src="slide3URL" alt="幻灯片 3" class="slide-3 swiper-lazy" rel="preload" /></swiper-slide>
      </swiper>
    </div>
  </main>
